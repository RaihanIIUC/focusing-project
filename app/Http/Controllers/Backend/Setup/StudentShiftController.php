...
class StudentShiftController extends Controller
{
    ...
    public function StudentAddShift(){
 ...
 public function StudentShiftStore(Request $request){
      ...
      $data->save();
       ...
       $notifiaction = array(
         'message' => 'Student Shift Inserted  and You win!! !!',
         'alert-type'=>'success'
       );

      return redirect()->route('student.shift.view')->with($notifiaction);
    ...
    public function StudentShiftUpdate(Request $request,$id){
      ...
      $data->save();
       ...
       $notifiaction = array(
         'message' => 'Student Shift Updated  and You win!! !!',
         'alert-type'=>'success'
       );
    ...
    public function StudentShiftDelete($id){
       ...
       $notifiaction = array(
         'message' => 'Student Shift Deleted  and You win!! !!',
         'alert-type'=>'info'
       );
